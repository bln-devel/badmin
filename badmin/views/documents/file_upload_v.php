	...
	?>
		<input type="file" name="userfile" size="20"> <input type="image" value="upload" src="<?= base_url() ?>/resources/core/images/famfamfam/page_white_add.png">
	</form>
	...
	<form action="<?= site_url("documents/upload/mkdir/".$path); ?>" method="post">
		...
		<input type="image" value="upload" src="<?= base_url() ?>/resources/core/images/famfamfam/folder_add.png">
	</form>